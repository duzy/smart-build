# -*- bash -*-
test-check-file ${BASH_SOURCE}:${LINENO} out/android-ndk/debug/intermediates/android_native_app_glue/android_native_app_glue.c.o
test-check-file ${BASH_SOURCE}:${LINENO} out/android-ndk/debug/intermediates/native-activity/toolsets/android-ndk/shared-library/na.c.o
test-check-file ${BASH_SOURCE}:${LINENO} out/android-ndk/debug/intermediates/native-activity/toolsets/android-ndk/shared-library/na.c.o.d
