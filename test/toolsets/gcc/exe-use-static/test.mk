...
#
####
test.case.exe-use-static-mk-loaded := 1
####
THIS_MAKEFILE := $(lastword $(MAKEFILE_LIST))
THIS_DIR := $(patsubst %/,%,$(dir $(THIS_MAKEFILE)))
$(call test-check-undefined, sm.this.dir)
$(call test-check-module-empty, sm.this)
$(call sm-new-module, exe-use-static, gcc: exe)
...
$(call test-check-undefined,sm.module.exe-use-static.used.libs)
$(sm-build-this)
$(call test-check-value,$(strip $(sm.module.exe-use-static.used.libs)),gcc-static)
