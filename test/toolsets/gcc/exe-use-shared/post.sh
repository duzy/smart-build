...
test-check-file ${BASH_SOURCE}:${LINENO} out/gcc/debug/intermediates/gcc-shared/_/shared/_/bar.c.o
test-check-file ${BASH_SOURCE}:${LINENO} out/gcc/debug/intermediates/gcc-shared/_/shared/_/bar.c.o.d
test-check-file ${BASH_SOURCE}:${LINENO} out/gcc/debug/intermediates/gcc-shared/_/shared/_/foo.c.o
test-check-file ${BASH_SOURCE}:${LINENO} out/gcc/debug/intermediates/gcc-shared/_/shared/_/foo.c.o.d
test-check-file ${BASH_SOURCE}:${LINENO} out/gcc/debug/intermediates/gcc-shared/_/shared/_/foo.go.o
test-check-file ${BASH_SOURCE}:${LINENO} out/gcc/debug/intermediates/gcc-shared/_/shared/_/foo.go.o.d
