# -*- bash -*-
test-check-file ${BASH_SOURCE}:${LINENO} $OUT_INTERS/module-of-type-exe-use-shared/main.c.o
test-check-file ${BASH_SOURCE}:${LINENO} $OUT_INTERS/module-of-type-exe-use-shared/main.c.o.d
