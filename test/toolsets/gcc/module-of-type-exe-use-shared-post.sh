...
out=`ldd $TOP/out/gcc/debug/bin/module-of-type-exe-use-shared$EXE | grep $TOP/out/gcc/debug/bin/module-of-type-shared.so`
test-check-value-contains ${BASH_SOURCE}:${LINENO} "$out" "$TOP/out/gcc/debug/bin/module-of-type-shared.so"
