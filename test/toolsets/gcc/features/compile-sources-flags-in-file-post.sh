...
test-check-file ${BASH_SOURCE}:${LINENO} $OUT_INTERS/features/feature-compile-sources-flags-in-file/foobar.c.o.d
test-check-file ${BASH_SOURCE}:${LINENO} $OUT_INTERS/features/feature-compile-sources-flags-in-file/foo.c.o
test-check-file ${BASH_SOURCE}:${LINENO} $OUT_INTERS/features/feature-compile-sources-flags-in-file/foo.c.o.d
test-check-file ${BASH_SOURCE}:${LINENO} $OUT_INTERS/features/feature-compile-sources-flags-in-file/bar.c.o
test-check-file ${BASH_SOURCE}:${LINENO} $OUT_INTERS/features/feature-compile-sources-flags-in-file/bar.c.o.d
