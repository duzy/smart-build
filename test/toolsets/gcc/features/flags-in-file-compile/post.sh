# -*- bash -*-
test-check-file ${BASH_SOURCE}:${LINENO} out/gcc/debug/intermediates/feature-flags-in-file-compile/toolsets/gcc/features/main.c.o
test-check-file ${BASH_SOURCE}:${LINENO} out/gcc/debug/intermediates/feature-flags-in-file-compile/toolsets/gcc/features/main.c.o.d
