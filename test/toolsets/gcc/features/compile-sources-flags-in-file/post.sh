...
test-check-file ${BASH_SOURCE}:${LINENO} out/gcc/debug/intermediates/feature-compile-sources-flags-in-file/toolsets/gcc/features/foobar.c.o
test-check-file ${BASH_SOURCE}:${LINENO} out/gcc/debug/intermediates/feature-compile-sources-flags-in-file/toolsets/gcc/features/foobar.c.o.d
test-check-file ${BASH_SOURCE}:${LINENO} out/gcc/debug/intermediates/feature-compile-sources-flags-in-file/toolsets/gcc/features/foo.c.o
test-check-file ${BASH_SOURCE}:${LINENO} out/gcc/debug/intermediates/feature-compile-sources-flags-in-file/toolsets/gcc/features/foo.c.o.d
test-check-file ${BASH_SOURCE}:${LINENO} out/gcc/debug/intermediates/feature-compile-sources-flags-in-file/toolsets/gcc/features/bar.c.o
test-check-file ${BASH_SOURCE}:${LINENO} out/gcc/debug/intermediates/feature-compile-sources-flags-in-file/toolsets/gcc/features/bar.c.o.d
