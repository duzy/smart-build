...
test-check-file ${BASH_SOURCE}:${LINENO} $OUT_INTERS/features/feature-compile-sources/foobar.c.o.d
test-check-file ${BASH_SOURCE}:${LINENO} $OUT_INTERS/features/feature-compile-sources/foo.c.o
test-check-file ${BASH_SOURCE}:${LINENO} $OUT_INTERS/features/feature-compile-sources/foo.c.o.d
test-check-file ${BASH_SOURCE}:${LINENO} $OUT_INTERS/features/feature-compile-sources/bar.c.o
test-check-file ${BASH_SOURCE}:${LINENO} $OUT_INTERS/features/feature-compile-sources/bar.c.o.d
