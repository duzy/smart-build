...
## eg. $(call sm.code.rule, ACTION, LANG, TARGET, PREREQUISITES, sources-replacement, callback, callback)
define sm.code.rule
...
$(eval $(call sm.code.rule,$(strip $1),$(strip $2),$(strip $3),$(strip $4),$(strip $5),$(strip $6),$(strip $7)))
endef #sm.rule
...
$(if $4,$(if $(call equal,$(4:@%=@),@),,$(error smart: 'sm.rule.link': arg 4 must be objects as '@file': $4)))\
