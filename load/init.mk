...
sm.char.null :=
define sm.char.newline


endef #sm.char.newline
define sm.char.linefeed

endef #sm.char.linefeed
define sm.char.space
...
sm.global.module_types := none static shared \
  static+shared shared+static \
  executable exe \
  tests t \
  depends \
  docs \
