...
##
##  sm.tool.android-ndk0
##

$(call sm-check-origin, sm.tool.android-ndk0, undefined)
...
sm.tool.android-ndk0 := true
sm.tool.android-ndk0.path := $(ANDROID_NDK_PATH)

################################################## Android NDK setup
## The variable "sm.tool.android-ndk0.path" must be defined first!!
sm.tool.android-ndk0.args :=
#include $(android.tool.dir)/android-ndk/init.mk
#include $(android.tool.dir)/android-ndk/imports.mk
################################################## Android NDK setup finished

sm.tool.android-ndk0.langs := c++ c asm
sm.tool.android-ndk0.suffix.c := .c
sm.tool.android-ndk0.suffix.c++ := .cpp .c++ .cc .CC .C
sm.tool.android-ndk0.suffix.asm := .s .S
sm.tool.android-ndk0.suffix.intermediate.c := .o
sm.tool.android-ndk0.suffix.intermediate.c++ := .o
sm.tool.android-ndk0.suffix.intermediate.asm := .o
sm.tool.android-ndk0.suffix.target.win32.static = $(error untested for win32)
sm.tool.android-ndk0.suffix.target.win32.shared = $(error untested for win32)
sm.tool.android-ndk0.suffix.target.win32.exe = $(error untested for win32)
sm.tool.android-ndk0.suffix.target.win32.t = $(error untested for win32)
sm.tool.android-ndk0.suffix.target.linux.static := .a
sm.tool.android-ndk0.suffix.target.linux.shared := .so
sm.tool.android-ndk0.suffix.target.linux.exe :=
sm.tool.android-ndk0.suffix.target.linux.t := .test

sm.tool.android-ndk0.flags.compile.variant.debug := -g -ggdb
sm.tool.android-ndk0.flags.compile.variant.release := -O3
sm.tool.android-ndk0.flags.link.variant.debug := -g -ggdb
sm.tool.android-ndk0.flags.link.variant.release := -O3

######################################################################

##
##
define sm.tool.android-ndk0.link
$(eval \
...
endef #sm.tool.android-ndk0.link

#$(info $(value cmd-build-static-library))
define sm.tool.android-ndk0.archive
$(eval \
...
endef #sm.tool.android-ndk0.archive

######################################################################

##
## Compile Commands
define sm.tool.android-ndk0.command.compile.c
$(TOOLCHAIN_PREFIX)gcc $(sm.var.flags) -o $(sm.var.intermediate) -c $(sm.var.source.computed)
endef #sm.tool.android-ndk0.command.compile.c

define sm.tool.android-ndk0.command.compile.c.d
$(TOOLCHAIN_PREFIX)gcc -MM -MT $(sm.var.intermediate) $(sm.var.flags) $(sm.var.source.computed) > $(sm.var.intermediate).d
endef #sm.tool.android-ndk0.command.compile.c.d
...
define sm.tool.android-ndk0.command.compile.go
$(TOOLCHAIN_PREFIX)gccgo $(sm.var.flags) -o $(sm.var.intermediate) -c $(sm.var.source.computed)
endef #sm.tool.android-ndk0.command.compile.go

define sm.tool.android-ndk0.command.compile.go.d
$(TOOLCHAIN_PREFIX)gccgo -MM -MT $(sm.var.intermediate) $(sm.var.flags) $(sm.var.source.computed) > $(sm.var.intermediate).d
endef #sm.tool.android-ndk0.command.compile.go.d

define sm.tool.android-ndk0.command.compile.asm
$(TOOLCHAIN_PREFIX)gcc $(sm.var.flags) -o $(sm.var.intermediate) -c $(sm.var.source.computed)
endef #sm.tool.android-ndk0.command.compile.asm

##
##
define sm.tool.android-ndk0.command.link.c
$(sm.tool.android-ndk0.link)
endef #sm.tool.android-ndk0.command.link.c

define sm.tool.android-ndk0.command.link.c++
$(sm.tool.android-ndk0.link)
endef #sm.tool.android-ndk0.command.link.c++

define sm.tool.android-ndk0.command.link.go
$(sm.tool.android-ndk0.link)
endef #sm.tool.android-ndk0.command.link.go

define sm.tool.android-ndk0.command.link.asm
$(sm.tool.android-ndk0.link)
endef #sm.tool.android-ndk0.command.link.asm

##
##
define sm.tool.android-ndk0.command.archive
$(sm.tool.android-ndk0.archive)
endef #sm.tool.android-ndk0.command.archive

######################################################################

##
##
define sm.tool.android-ndk0.config-module
$(call sm-check-not-empty, \
    sm.os.name \
    sm.config.variant \
 )\
$(eval \
   sm.tool.android-ndk0.args := $(sm.this.toolset.args)
   include $(android.tool.dir)/android-ndk/init.mk
   include $(android.tool.dir)/android-ndk/imports.mk
 )\
$(eval \
   ...
   sm.this.suffix := $$(sm.tool.android-ndk0.suffix.target.$(sm.os.name).$$(sm.this.type))
   sm.this.includes := $(TARGET_C_INCLUDES)
   sm.this.compile.flags := $(sm.tool.android-ndk0.flags.compile.variant.$(sm.config.variant))
   sm.this.compile.flags += -DANDROID $(TARGET_CFLAGS)
   sm.this.link.flags := $(sm.tool.android-ndk0.flags.link.variant.$(sm.config.variant))
   sm.this.link.flags += $(TARGET_LD_FLAGS)
   sm.this.libdirs :=
   sm.this.libs :=
 )
endef #sm.tool.android-ndk0.config-module

define sm.tool.android-ndk0.args.types
$(filter-out ABI=% PLATFORM=%, $($(sm._this).toolset.args))
endef #sm.tool.android-ndk0.args.types

sm.tool.android-ndk0.transform.headers := h
sm.tool.android-ndk0.transform.static  := bin
sm.tool.android-ndk0.transform.shared  := bin
sm.tool.android-ndk0.transform.exe     := bin
...
define sm.tool.android-ndk0.transform-single-source
$(foreach _, $(sm.tool.android-ndk0.args.types), \
  $(call sm.tool.android-ndk0.transform-source-$(sm.tool.android-ndk0.transform.$_)))
endef #sm.tool.android-ndk0.transform-single-source

##
##
define sm.tool.android-ndk0.transform-source-h
$(info TODO: android-ndk: header: $(sm.var.source.computed))
endef #sm.tool.android-ndk0.transform-source-h

##
##
define sm.tool.android-ndk0.transform-source-bin
$(call sm-check-not-empty, \
...
$(eval #
  ...
  sm.var.command := $$(sm.tool.android-ndk0.command.compile.$(sm.var.source.lang))
  sm.var.command.d := $$(sm.tool.android-ndk0.command.compile.$(sm.var.source.lang).d)
 )\
$(eval #
...
endef #sm.tool.android-ndk0.transform-source-bin

##
##
define sm.tool.android-ndk0.transform-intermediates
$(foreach _, $(sm.tool.android-ndk0.args.types), \
     $(call sm.tool.android-ndk0.transform-intermediates-$(sm.tool.android-ndk0.transform.$_)))
endef #sm.tool.android-ndk0.transform-intermediates

##
##
define sm.tool.android-ndk0.transform-intermediates-h
$(info TODO: android-ndk: header: $(sm.var.source.computed))
endef #sm.tool.android-ndk0.transform-intermediates-h

##
##
define sm.tool.android-ndk0.transform-intermediates-bin
...
$(eval #
  ...
  ifeq ($($(sm._this).type),static)
    sm.var.command := $(sm.tool.android-ndk0.command.archive)
  else
    sm.var.command := $(sm.tool.android-ndk0.command.link.$($(sm._this).lang))
  endif
 )\
$(eval #
...
endef #sm.tool.android-ndk0.transform-intermediates-bin
