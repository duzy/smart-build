...
$(call sm-var-temp, _archive_cmd, :=, $(AR) crus)
$(call sm-var-temp, _archive_name, :=, $(sm.module.name)$(sm.module.suffix))
$(call sm-var-temp, _archive, :=, $(sm.dir.out.lib)/$(sm.var.temp._archive_name))
$(call sm-var-temp, _prompt, :=, echo "$(sm.module.type): $(sm.var.temp._archive)")

$(call sm-var-temp, _link, =)
sm.var.temp._link = for o in $(sm.module.objects) ; do \
  $(sm.var.temp._archive_cmd) $(sm.var.temp._archive) $$$$o || exit ; done \
