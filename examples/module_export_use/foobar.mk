...
$(call sm-new-module, foobar, gcc: exe)

sm.this.verbose := true
sm.this.sources := foobar.cpp

_this.defines := $(sm.this.defines)
_this.includes := $(sm.this.includes)
_this.compile.flags := $(sm.this.compile.flags)
_this.link.flags := $(sm.this.link.flags)
...
$(call sm-check-equal,$(_this.defines),$(sm.this.defines))
$(call sm-check-equal,$(_this.includes),$(sm.this.includes))
$(call sm-check-equal,$(_this.compile.flags),$(sm.this.compile.flags))
$(call sm-check-equal,$(_this.link.flags),$(sm.this.link.flags))
