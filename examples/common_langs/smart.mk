...
$(call sm-check-equal,$(sm.this.sources.c++),foo2.cpp $(prefix)/foo4.cpp $(prefix)/foo5.cpp)
$(call sm-check-equal,$(sm.this.sources.pascal),$(prefix)/foo3.p)
...
$(call sm-check-equal,$(sm.var.foo.sources.c++),foo2.cpp $(prefix)/foo4.cpp $(prefix)/foo5.cpp)
#$(call sm-check-equal,$(sm.var.foo.sources.pascal),$(prefix)/foo3.p)
