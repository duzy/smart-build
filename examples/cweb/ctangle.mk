...
$(call sm-check-equal,$(strip $(sm.module.ctangle.sources.c)),$(prefix)/ctangle.c $(prefix)/common.c)
$(call sm-check-equal,$(strip $(sm.module.ctangle.sources.TeX)),cwebman.tex $(prefix)/ctangle.tex $(prefix)/common.tex)
